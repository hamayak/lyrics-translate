              ...
              <v-col cols="6" >
                ...
                <v-row class="abouttranslator">
                  <v-col cols="6">
                    <v-card-text>
                    <ul>
                      <li><b> Name: </b> Matthew</li>
                      <li><b>Role: </b>Memeber</li>
                      <li><b>Contribution: </b>9 translations, 1 transliteration, thanked 74 times, solved 3 requests, helped 3 members</li>
                      <li><b>Languages: </b>native English, studied Norwegian, Spanish, Old Norse/Norrønt</li>
                    </ul>
                </v-card-text>
                  </v-col>
                </v-row>
